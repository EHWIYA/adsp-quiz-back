...
export AUTO_VALIDATE_QUIZ="${AUTO_VALIDATE_QUIZ:-false}"
export AUTO_VALIDATE_SAMPLE_RATE="${AUTO_VALIDATE_SAMPLE_RATE:-0.1}"
...
AUTO_VALIDATE_QUIZ=${AUTO_VALIDATE_QUIZ:-false}
AUTO_VALIDATE_SAMPLE_RATE=${AUTO_VALIDATE_SAMPLE_RATE:-0.1}
